...
<?php
// Recebendo valores do atributo - index.php
...
elseif (valida_cpf($cpf) == true) {
	...
	<section class="informativo">
		<h4>Cadastro realizado com sucesso <?php echo $nikname . '!' ?></h4>
...
?>
	<section class="informativo">
		<h4><b>CPF invalído preencha novamente <?php echo $nikname . '!' ?></b></h4>
		<a href="index.php?id=<?php echo $nikname ?>"><button type="button" class="btn btn-danger btn-sm"><svg width="1.4em" height="1.4em" viewBox="0 0 16 16" class="bi bi-person-x-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
